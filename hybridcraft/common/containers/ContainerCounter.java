...
public class ContainerCounter extends ContainerWorkbench {
	...
	public boolean canInteractWith(EntityPlayer par1EntityPlayer) {
		return this.worldObj.getBlockId(this.posX, this.posY, this.posZ) != hybridcraft.common.mod.init.Blocks.counter.blockID ? false : par1EntityPlayer.getDistanceSq((double) this.posX + 0.5D, (double) this.posY + 0.5D, (double) this.posZ + 0.5D) <= 64.0D && (this.worldObj.getBlockId(this.posX + 1, this.posY, this.posZ) == hybridcraft.common.mod.init.Blocks.stove.blockID || this.worldObj.getBlockId(this.posX - 1, this.posY, this.posZ) == hybridcraft.common.mod.init.Blocks.stove.blockID || this.worldObj.getBlockId(this.posX, this.posY, this.posZ + 1) == hybridcraft.common.mod.init.Blocks.stove.blockID || this.worldObj.getBlockId(this.posX, this.posY, this.posZ - 1) == hybridcraft.common.mod.init.Blocks.stove.blockID);
	}
}
