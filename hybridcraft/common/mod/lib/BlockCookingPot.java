...
public class BlockCookingPot extends Block {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
		if (par1World.getBlockId(par2, par3, par4) != hybridcraft.common.mod.init.Blocks.cookingPot.blockID ? false : par5EntityPlayer.getDistanceSq((double) par2 + 0.5D, (double) par3 + 0.5D, (double) par4 + 0.5D) <= 64.0D){
			par5EntityPlayer.openGui(hybridcraft.common.mod.Hybridcraft.instance, 2, par1World, par2, par3, par4);
			return true;
		} 
		return false;
	}
	...
	public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
		return par1World.getBlockId(par2, par3-1, par4) == hybridcraft.common.mod.init.Blocks.stove.blockID;
	}
