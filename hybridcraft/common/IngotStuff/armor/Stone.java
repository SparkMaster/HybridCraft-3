...
public class Stone extends ItemArmor implements IArmorTextureProvider{
 ...
 if ( par1.itemID==Hybridcraft.stoneHelmet.shiftedIndex|| par1.itemID==Hybridcraft.stonePlate.shiftedIndex||
 par1.itemID==Hybridcraft.stoneBoots.shiftedIndex){
 return "/hc/armor/stone_1.png";
 }if(par1.itemID==Hybridcraft.stoneLegs.shiftedIndex){
