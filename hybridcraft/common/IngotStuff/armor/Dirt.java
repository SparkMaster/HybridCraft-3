...
public class Dirt extends ItemArmor implements IArmorTextureProvider{
 ...
 if ( par1.itemID==Hybridcraft.dirtHelmet.shiftedIndex|| par1.itemID==Hybridcraft.dirtPlate.shiftedIndex||
 par1.itemID==Hybridcraft.dirtBoots.shiftedIndex){
 return "/hc/armor/dirt_1.png";
 }if(par1.itemID==Hybridcraft.dirtLegs.shiftedIndex){
