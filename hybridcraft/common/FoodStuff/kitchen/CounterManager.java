...
import hybridcraft.common.FoodStuff.*;
...
public class CounterManager extends AbstractCraftingManager {
	...
	private CounterManager() {
		...
		// Classify Items
		breadSlice = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.breadSliceID, 1).setIconIndex(0).setItemName("Bread Slice");
		chickenStrips = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.chickenStripsID, 3).setIconIndex(1).setItemName("Chicken Strips");
		beefSlices = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.beefSlicesID, 4).setIconIndex(2).setItemName("Beef Slice");
		bacon = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.baconID, 4).setIconIndex(3).setItemName("Bacon");
		chickenSandwich = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.chickenSandwichID, 8).setIconIndex(4).setItemName("Chicken Sandwich");
		chickenSandwichBacon = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.chickenSandwichBaconID, 9).setIconIndex(5).setItemName("Chicken Sandwich");
		beefSandwich = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.beefSandwichID, 10).setIconIndex(6).setItemName("Beef Sandwich");
		beefSandwichBacon = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.beefSandwichBaconID, 10).setIconIndex(7).setItemName("Pork Sandwich");
		meatSandwich = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.meatSandwichID, 9).setIconIndex(8).setItemName("Meat Sandwich");
		appleSlice = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.appleSliceID, 1).setIconIndex(9).setItemName("Apple Slice");
		fruitSalad = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.fruitSaladID, 9).setIconIndex(10).setItemName("Fruit Salad");
		applePie = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.applePieID, 10).setIconIndex(11).setItemName("Apple Pie");
