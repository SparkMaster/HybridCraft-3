...
public class StoveManager extends AbstractCraftingManager {
	...
	private StoveManager() {
		...
		// Classify Items
		BaB = new FoodBread(hybridcraft.common.FoodStuff.HybridModFoodStuff.BaBID, 8, false).setIconIndex(0).setItemName("bab");
		PaB = new FoodBread(hybridcraft.common.FoodStuff.HybridModFoodStuff.PaBID, 10, false).setIconIndex(1).setItemName("pab");
		CaB = new FoodBread(hybridcraft.common.FoodStuff.HybridModFoodStuff.CaBID, 10, false).setIconIndex(2).setItemName("cab");
		DogBread = new FoodBread(hybridcraft.common.FoodStuff.HybridModFoodStuff.DogBreadID, 10, true).setIconIndex(3).setItemName("db");
