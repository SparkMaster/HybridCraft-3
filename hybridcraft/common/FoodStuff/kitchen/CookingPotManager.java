...
public class CookingPotManager extends AbstractCraftingManager {
	...
	private CookingPotManager() {
		...
		// Classify Items
		bowlChicken = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.bowlChickenID, 9).setIconIndex(12).setItemName("Chicken Soup");
		bowlBeef = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.bowlBeefID, 8).setIconIndex(13).setItemName("Beef Stew");
		bowlMeat = new Sandwich(hybridcraft.common.FoodStuff.HybridModFoodStuff.bowlMeatID, 10).setIconIndex(14).setItemName("Broth");
